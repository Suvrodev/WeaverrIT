    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row gap-0 items-center max-w-7xl mx-auto ">
        <div className="w-full md:w-[50%] p-5 flex flex-col justify-center items-center ">
          ...
          <h1 className="p-0 text-white">
            {desc ? (
              desc
            ) : (
              <p className="text-2xl font-bold" key={1122}>
                UpComming
              </p>
            )}
          </h1>
        ...
        <div className="w-full md:w-[50%] flex flex-col  items-center ">
          ...
          <h1 className="grid grid-cols-1 md:grid-cols-2 gap-6 my-10">
            ...
            {provides ? (
              ...
              <div>
                <h1 className=" text-2xl font-bold text-white">UpComming</h1>
              </div>
            )}
          </h1>
        </div>
        <div className="w-full md:w-[50%]   flex flex-col  gap-5 ">
          ...
          <div className="bg-[#4CBD90] p-5 rounded-lg flex flex-col gap-2 w-full md:w-10/12 ">
            ...
            <h1 className="text-xl font-bold">
              {onlineReg ? (
                <div>Regular Fee : BDT {onlineReg} </div>
              ) : (
                "Upcomming"
              )}
            </h1>
            <h1 className="text-xl font-bold">
              {onlineOfferIs && (
                <div className=" flex items-center gap-2 ">
                  <p> Offer Fee : BDT {onlineOffer}</p>
                  <p className="font-normal">
                    ({onlineOfferPercent} {onlineOfferReason})
                  </p>
                </div>
              )}
            </h1>
            <button
              ...
              className="btn bg-white w-full md:w-6/12 text-[#4CBD90] font-bold border-0 "
            >
              Enroll Now
            </button>
          </div>
          ...
          <div className="bg-[#4CBD90] p-5 rounded-lg flex flex-col gap-2  w-full md:w-10/12">
            ...
            <h1 className="text-xl font-bold">
              {offline ? offline : "Upcomming"}
            </h1>
            <button className="btn bg-white w-full md:w-6/12 text-[#4CBD90] font-bold border-0">
              Enroll Now
            </button>
          </div>
        </div>
