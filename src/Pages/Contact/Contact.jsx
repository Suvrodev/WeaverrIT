...
import { FaArrowRight, FaCheck, FaClock, FaFacebook, FaHeadset, FaInstagram, FaLinkedin, FaMailBulk, FaMap, FaMapMarkerAlt, FaPhoneAlt, FaTwitter, FaWhatsapp } from 'react-icons/fa';
           ...
           <Helmet>
            ...
            <div className='flex flex-col justify-center items-center'>
              <div className='flex items-center gap-4 bg-white text-black p-3 rounded-xl font-bold shadow-sm my-4'>
               ...
               <h1 className='text-4xl text-white font-bold'> <span className='text-[#4CBD90]'>Contact</span> & Join Together</h1>
               <p className='my-4'>Sint nascetur facere, delectus conubia consequuntur, nonummy distinctio! Non officiis, id natus non nisl provident justo.</p>
            </div>
...
{/* 
          ...
          <div className='w-[40%]'>
            ...
            <div className='w-full my-20'>
                <div className='bg-purple-400 w-full flex flex-col md:flex-row mx-auto'>
                    <div className='bg-[#4CBD90] w-full md:w-[50%] p-5'>
                        <h1 className='font-bold text-3xl text-center'>Perfect Solutions For Your Business</h1>
                        <p className=' my-4'>
                        ...
                        <div className='my-6 flex flex-col gap-2'>
                            <p className='flex gap-4 items-center'> <FaCheck /> We are committed to providing quality IT Services   </p>
                            <p className='flex gap-4 items-center'> <FaCheck /> We are committed to providing quality IT Services   </p>
                            <p className='flex gap-4 items-center'> <FaCheck /> We are committed to providing quality IT Services   </p>
                            <p className='flex gap-4 items-center'> <FaCheck /> We are committed to providing quality IT Services   </p>
                        </div>
                        ...
                        <div className='flex items-center justify-start'>
                            <div className='w-[50%]'><button className='btn bg-white  border-0 text-[#4CBD90]'>GET A QUOTE</button></div>
                            <h1 className='flex items-center gap-4'>Get Started <FaArrowRight /> </h1>
                        </div>
                    </div>
            ...
            <div className='text-[#4CBD90] flex gap-10 justify-center  md:w-2/12 mx-auto text-2xl text-center '>
              ...
              <Link to='' onClick={handleWhatsapp} target='_blank'><FaWhatsapp/></Link>
            </div>
        </div>
    );
};
