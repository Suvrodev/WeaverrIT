...
const Footer = () => {
  ...
  //4A5466
    return (
       <div className='  bg-[#0B1221] flex flex-col items-center text-white'>
            ...
            <aside>
              <img className='w-[146px]' src={Logo} alt="" />
                    ...
                    <div className='flex gap-4 text-xl mt-2'>
                        ...
                        <Link to={'https://www.linkedin.com/company/weaverrit/'}> <FaLinkedin/> </Link>
                        <Link to='' onClick={handleWhatsapp}> <FaWhatsapp/> </Link>
