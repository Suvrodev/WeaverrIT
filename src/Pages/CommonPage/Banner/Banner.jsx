...
const Banner = () => {
    return (
        <div className='w-full md:h-[400px] md:w-[100%] bg-[var(--banner-color)] flex flex-col items-center md:flex-row rounded-lg'>
            <div className='w-full md:w-[50%] h-[350px] flex items-center justify-center flex-col gap-5 p-5'>
