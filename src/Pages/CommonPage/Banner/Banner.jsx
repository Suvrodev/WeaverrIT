    ...
    <div className="w-full md:h-[450px] md:w-[100%] bg-[var(--banner-color)] flex flex-col items-center md:flex-row rounded-lg">
      <div className="w-full md:w-[50%] h-[450px] flex items-center justify-center flex-col gap-5 p-5">
        ...
        <h1 className="text-3xl font-bold">
          ...
          দক্ষতার <span className="text-yellow-300"> আত্মবিশ্বাসে</span>{" "}
        </h1>
        <p className="text-center">
          অভিজ্ঞ মেন্টর আর আপডেটেড কারিকুলাম নিয়ে ওয়েভার আইটি প্রস্তুত আপনার
        ...
        <div className="flex flex-col md:flex-row gap-5">
          <Link to={"/contact"}>
            <button className="btn btn-warning text-white text-2xl">
              Contact
            </button>
          </Link>
